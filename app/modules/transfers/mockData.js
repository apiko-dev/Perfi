...
export default [
  ...
  createTransaction({ value: -50, account: '3', category: '3', date: moment().subtract(200, 'days'), isFavourite: true }),
  ...
  createTransaction({ value: -100, account: '3', category: '6', date: moment().subtract(120, 'days') }),
